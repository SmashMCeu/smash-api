...
public class CommonTranslations {
	...
	public static final String CHAT_INVALID_ARGUMENTS = "chat.invalid_arguments";
	public static final String CHAT_INVALID_ARGUMENTS_USE = "chat.invalid_arguments_use";
